...
CREATE TABLE `mt_coupon` (
  ...
  `STATUS` char(1) DEFAULT 'A' COMMENT 'A：正常；D：删除',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='卡券信息表';
...
CREATE TABLE `mt_message` (
  ...
  `TITLE` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '友情提示' COMMENT '消息标题',
...
CREATE TABLE `mt_order` (
  ...
  `OPERATOR` varchar(30) DEFAULT '' COMMENT '最后操作人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COMMENT='订单表';
...
CREATE TABLE `mt_point` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8 COMMENT='积分变化表';
...
CREATE TABLE `mt_setting` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='全局设置表';
...
CREATE TABLE `mt_user` (
  ...
  `GRADE_ID` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '1' COMMENT '等级ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=165 DEFAULT CHARSET=utf8 COMMENT='会员个人信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=199 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='会员优惠券表';
...
CREATE TABLE `t_action_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8336 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=5896 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='菜单表';
