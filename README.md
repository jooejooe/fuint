...
#### 介绍
欢迎使用FuInt会员营销系统。本项目包含优惠券、预存卡、集次卡、短信发送、储值卡、电子券，会员积分体系，支付收款、商品购买等营销功能。源码完整，包含前台微信小程序、h5、后端api、后台管理系统。本系统适用于各类实体店铺，如酒店、汽车4S店、鲜花店、甜品店、餐饮店等，是实体店铺会员营销必备的一款利器。
以下是前台的页面展示：
...
不足和待完善之处请谅解！源码仅供学习交流，更多功能欢迎咨询讨论（备注Fuint），如需安装帮助请联系我们。<br>
官方网站：https://www.fuint.cn <br>
开源不易，麻烦点star，给我们一点反馈。<br>
