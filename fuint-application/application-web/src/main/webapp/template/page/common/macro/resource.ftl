...
<script src="<@sp.static/>/js/jquery/validation/messages_zh.min.js?v=1.0.0" type="text/javascript" charset="UTF-8"></script>
<script src="<@sp.static/>/js/custom/validation/validate-methods.js?v=1.0.0" type="text/javascript" charset="UTF-8"></script>
<!-- jquery ui -->
...
<script src="<@sp.static/>/js/custom/map.js?v=1.0.0" type="text/javascript" charset="UTF-8"></script>
<!-- 消息框 -->
